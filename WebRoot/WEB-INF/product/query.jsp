		...
		$(function(){
			$('#dg').datagrid({   
				...
				toolbar: [{
					...
					handler: function(){
						...
						if(rows.length == 0) {
							...
							$.messager.confirm('删除的确认对话框', '您确定要删除此项吗？（一旦删除不可恢复）', function(r){
								if (r){
			    ...
			    frozenColumns:[[
					...
					{field:'id',title:'商品编号',width:100}    //这里的field字段要和数据库中的一样，也就是要跟json数据中的一样             
			    ]],
			    //配置datagrid的列字段 
			    ...
			    columns:[[    		           
			        ...
			        {field:'remark',title:'简要描述',width:100},
